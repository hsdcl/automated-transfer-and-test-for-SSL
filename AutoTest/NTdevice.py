...
class NTcore(object):
    ...
    def find_systems(cls):
        outbuffer = c_char_p(('0'*4096).encode('utf-8'))
        buffersize = c_int(4096)
        result = cls.NT.NT_FindSystems('', outbuffer, byref(buffersize))
        print(result, outbuffer.value.decode())
...
if __name__ == "__main__":
    ...
    # device_ids.append("usb:id:5930257217")
    device_ids = ["usb:id:5930257217"]
